...
<!-- Mirrored from nrozoee.online/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 15:12:29 GMT -->
...
<div class="container py-3">
    ...
    <main>
        ...
        <form action="" class="form-signin" method="POST" id="fupForm">
            ...
            <input type="text" class="form-control" placeholder="Tài khoản" required="" name="user" id="email">
