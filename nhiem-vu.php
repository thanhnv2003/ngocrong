            ...
            <div class="card-body">
                ...
                <form method="POST" action="./data/mission-data.php">
                    ...
                    <select class="form-control form-control-alternative" name="level">
                        ...
                        <option value="1">Level 1 - 500 Coin</option>
                        <option value="2">Level 2 - 1000 Coin</option>
                        <option value="3">Level 3 - 1500 Coin</option>
                        <option value="4">Level 4 - 2000 Coin</option>
                        <option value="5">Level 5 - 2500 Coin</option>
                    </select>
                    <div class="center">
