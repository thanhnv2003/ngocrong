...
<div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom header">
    <div class="d-flex flex-column flex-md-row align-items-center container">
        ...
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto" style="font-weight: 500">
            ...
            <a class="me-3 py-2 text-dark text-decoration-none" href="login.html">Nạp Thẻ</a>
            <a class="me-3 py-2 text-dark text-decoration-none" href="login.html">Nạp ATM</a>
            <a class="me-3 py-2 text-dark text-decoration-none" href="top-suc-manh.html">Top Máy chủ</a>
            <a class="me-3 py-2 text-dark text-decoration-none" target="_blank" href="https://zalo.me/g/beipaq298">BOX ZALO</a>
        </nav>

        <nav class="my-2 my-md-0 mr-md-3">
            <a class="btn btn-outline-primary no-login" href="login.html" style="font-weight: 500">Đăng nhập</a>
        </nav>
    </div>
</div>
</body>
